...
if last_rank==1
    ...
    Population_ch(1:pop_size)=struct('chromesome',[],'decode',[],'pro_time',[],'objectives',[],'load_machine',[],'load_inbalance_ma',0,'load_worker',[],'load_inbalance_wo',0,'rank',0,'critical_path',[],'crowded_distance',0); 
