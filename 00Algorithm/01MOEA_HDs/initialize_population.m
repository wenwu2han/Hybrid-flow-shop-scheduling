function [Population_st]=initialize_population(pop_size,job_num,chrom_length)
%inputs
...
Population_st(1:pop_size)=struct('chromesome',[],'decode',[],'pro_time',[],'objectives',[],'load_machine',[],'load_worker',[],'rank',0,'crowded_distance',0,'cross_f',false);
